...
public class PreloginUI {
    ...
    public void help() {
        ...
        System.out.println("    " + EscapeSequences.SET_TEXT_COLOR_GREEN + "Register: " + EscapeSequences.SET_TEXT_COLOR_MAGENTA +
                " <username> <password> <email> " + EscapeSequences.SET_TEXT_COLOR_BLUE + "- registers an account");
        System.out.println("    " + EscapeSequences.SET_TEXT_COLOR_GREEN + "Login: " + EscapeSequences.SET_TEXT_COLOR_MAGENTA +
                " <username> <password> " + EscapeSequences.SET_TEXT_COLOR_BLUE + "- logs in an account");
        ...
        System.out.println("    " + EscapeSequences.SET_TEXT_COLOR_GREEN + "help " +
                EscapeSequences.SET_TEXT_COLOR_BLUE + "- displays possible commands" + EscapeSequences.RESET_TEXT_COLOR);
    }
